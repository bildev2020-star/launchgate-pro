...
export const mockTasks: Task[] = [
  // Step 1 tasks
  { id: 't1.1', step_id: 's1-1', project_id: 'proj-001', title: 'Transmettre nom commercial', description: 'Communiquer le nom commercial définitif du produit.', owner_role: 'Business Developer', statut: 'Done', dependency_task_ids: [], approval_required: false, approver_roles: [], priority: 'High', created_at: '2026-01-15', updated_at: '2026-01-20', step_order: 1 },
  { id: 't1.2', step_id: 's1-1', project_id: 'proj-001', title: 'Transmettre caractéristiques techniques', description: 'Fournir les spécifications techniques du produit.', owner_role: 'Validation', statut: 'Done', dependency_task_ids: [], approval_required: false, approver_roles: [], priority: 'High', created_at: '2026-01-15', updated_at: '2026-01-22', step_order: 1 },
  { id: 't1.3', step_id: 's1-1', project_id: 'proj-001', title: 'Préparer dossier de pré-soumission', description: 'Compilation du dossier réglementaire de pré-soumission.', owner_role: 'AR', statut: 'Done', dependency_task_ids: ['t1.1', 't1.2'], approval_required: true, approver_roles: ['AR', 'Validation'], priority: 'High', created_at: '2026-01-20', updated_at: '2026-02-05', step_order: 1 },
  { id: 't1.4', step_id: 's1-1', project_id: 'proj-001', title: 'Préparer maquettes BAT', description: 'Création des maquettes Bon À Tirer.', owner_role: 'Marketing', statut: 'Done', dependency_task_ids: ['t1.1', 't1.2'], approval_required: true, approver_roles: ['Marketing', 'AR'], priority: 'Med', created_at: '2026-01-20', updated_at: '2026-02-08', step_order: 1 },
  { id: 't1.5', step_id: 's1-1', project_id: 'proj-001', title: "Préparer programme d'importation", description: "Élaboration du programme d'importation réglementaire.", owner_role: 'AR', statut: 'Done', dependency_task_ids: ['t1.3'], approval_required: false, approver_roles: [], priority: 'Med', created_at: '2026-02-01', updated_at: '2026-02-10', step_order: 1 },
  // Step 2 tasks
  { id: 't2.1', step_id: 's1-2', project_id: 'proj-001', title: 'Commander intrants production', description: 'Passer les commandes pour les intrants de production.', owner_role: 'Supply', statut: 'Done', dependency_task_ids: ['t1.2'], approval_required: false, approver_roles: [], priority: 'High', created_at: '2026-02-11', updated_at: '2026-02-15', step_order: 2 },
  { id: 't2.2', step_id: 's1-2', project_id: 'proj-001', title: 'Identifier intrants QC', description: 'Identifier les intrants nécessaires au contrôle qualité.', owner_role: 'QC', statut: 'Done', dependency_task_ids: ['t1.2'], approval_required: false, approver_roles: [], priority: 'Med', created_at: '2026-02-11', updated_at: '2026-02-14', step_order: 2 },
  { id: 't2.3', step_id: 's1-2', project_id: 'proj-001', title: 'Commander intrants QC', description: 'Commander les intrants QC identifiés.', owner_role: 'Supply', statut: 'Done', dependency_task_ids: ['t2.2'], approval_required: false, approver_roles: [], priority: 'Med', created_at: '2026-02-14', updated_at: '2026-02-18', step_order: 2 },
  { id: 't2.7', step_id: 's1-2', project_id: 'proj-001', title: 'Réception/contrôle/libération intrants', description: 'Réceptionner, contrôler et libérer les intrants.', owner_role: 'Supply', statut: 'Done', dependency_task_ids: ['t2.1', 't2.3'], approval_required: true, approver_roles: ['QC', 'Supply'], priority: 'High', created_at: '2026-02-20', updated_at: '2026-03-15', step_order: 2 },
  // Step 3 tasks
  { id: 't3.1', step_id: 's1-3', project_id: 'proj-001', title: 'Lancer change control eQMS', description: 'Initier le change control dans le système eQMS.', owner_role: 'Validation', statut: 'InProgress', dependency_task_ids: ['t2.7'], approval_required: false, approver_roles: [], priority: 'High', created_at: '2026-03-16', updated_at: '2026-03-20', step_order: 3 },
